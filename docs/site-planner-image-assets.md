...
- The Save button downloads `hakomachi-site.zip`.
- The ZIP contains `hakomachi-site.hako-site.json`.
...
- If changing the asset layout, update both local ZIP load/save and GitHub load/save together.
