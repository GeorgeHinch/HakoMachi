...
function bottomTongueForbiddenZones(doors, cfg, wallH) {
  return doors
    .filter(d => {
 ...
 */
function cutDoorCoreHoles(rects, x, y, w, h, style, mirrorX) {
 ...
 */
function emitDoorShapesSvg(shapes, ox, oy, s, opts) {
  opts = opts || {};
 ...
 */
function buildDoorSvgBody(style, w, h, opts) {
  if (!style) return '';
  opts = opts || {};
