...
function generateBuildingStl(cfg) {
...
function onOverhangInput(axis, val) {
...
function updateOverhangLinkBtn() {
...
function isLikelyHakoMachiSitePlanSeed(data) {
...
function validKeyOrFallback(key, dict, fallback) {
  return (key && dict && dict[key]) ? key : fallback;
}

function hakoSiteFabricDefaults(fabricType) {
...
function findHakoSiteBuildingSeed(data) {
...
function normalizeHakoMachiSitePlanSeedToConfig(input, warnings) {
