...
function weEventTargetIsEditable(e) {
  const el = e && e.target;
  if (!el) return false;
...
function weDeleteSelectedWingWithConfirm() {
...
function weGetResizeHandles(cfg, wing, ox, oy, s) {
...
let _weDragState = null;

function weOnMouseDown(e) {
...
function weRenderTrussSection(sidebar, blockObj, onChange) {
  if (!blockObj.trusses) {
