...
export function i18nStyleGroupObject(groupName) {
  try {
    return ({
...
export function applyDynamicObjectI18n() {
...
/* -------------------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
export let _textRegistry = null;

export const _I18N_SKIP = new Set(['SCRIPT','STYLE','SELECT','SVG','CANVAS','TEXTAREA']);

export function buildTextRegistry() {
  _textRegistry = [];
  const roots = [
