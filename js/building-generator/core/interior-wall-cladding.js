 ...
 * =========================================================================== */
export function clipInteriorRectToBand(r, y0, y1) {
...
export function clipInteriorLineToBand(l, y0, y1) {
...
export function splitInteriorCladdingPartByFloors(part, plan, interiorTopWallY, interiorBottomWallY) {
  if (!part) return [];
...
export function generateInteriorCladdingPanel(cfg, plan, which) {
...
export function pointInPolygonEvenOdd(x, y, poly) {
  let inside = false;
...
export function clipSegmentToPolygonPieces(x1, y1, x2, y2, poly) {
...
export function generateInnerParapetCladding(cfg, plan) {
...
export function generateBayDoorParts(cfg, plan) {
  const parts = [];
