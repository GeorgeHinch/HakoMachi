...
*/
export function generateRoofFasciaTrim(cfg, plan) {
 ...
 */
export function wallXFromCladdingX(cladX, cladW, which, plan, cfg) {
...
export function generateCladdingPanel(cfg, plan, which, band) {
