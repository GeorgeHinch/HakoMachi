...
export const WALL_EXPOSURE_TYPES = {
...
export function normalizeSegmentedWallExposureZones(cfg) {
...
export function floorIndexAtWallY(plan, y) {
  if (!plan) return 0;
...
export function yRangeForFloorSpan(plan, fromFloor, toFloor) {
...
export function wallExposureAt(cfg, plan, edgeId, t, floorIndex) {
...
export function wallExposureAllowsRect(cfg, plan, edgeId, x, y, w, h, kind, wallW, wallH) {
...
export function filterWallExposureRects(items, cfg, plan, edgeId, kind, wallW, wallH, xKey = 'x', yKey = 'y', wKey = 'width', hKey = 'height') {
...
export function wallExposureNoCladdingWallRects(cfg, plan, edgeId, wallW, wallH) {
...
export function computeSegmentedExposureFromNeighbors(current, neighbors = [], opts = {}) {
...
export function computeWindows(wallW, wallH, opts) {
...
export function computeDoors(wallW, wallH, opts) {
...
export function buildEdgePlans(cfg) {
...
export function applyWingOpenings(rects, cfg, wallKey, wallW, wallH) {
...
export function generateSideWall(cfg, plan, side) {
...
export function bayDoorAlignmentMarks(cfg, plan, which) {
...
export function generateFrontBackWall(cfg, plan, which) {
...
export function buildFBWallWithBay(spec, plan) {
...
export function rooftopEquipmentEtchLines(plan, offsetX = 0, offsetY = 0) {
  const lines = [];
...
export function addRoofMechRoomAndEquipment(plan, cfg, rects, lines, roofIsRecessed) {
