 ...
 */
export function generateColumnFlangePiece(H, flangeW, matT, slotPositions, slotLen, topNotch) {
  let paths;
 ...
 *  in y-down coords. */
export function generateColumnWebPiece(H, webDepth, matT, slotPositions, slotLen, outerTabs = true) {
...
export function generateColumnSupportsForBlock(blockCfg, blockPlan, sfx, nameLbl, cropCtx) {
...
export function applyColumnFloorEtchings(parts, etches) {
...
export function transformColumnEtchLine(e, pointMapper) {
...
export function sameWingFloorTransform(part, cfg, wing) {
...
export function findPanelizedWingFloorPart(parts, cfg, wing) {
  return (parts || []).find(p =>
    p && p.material === 'core'
...
export function applyWingColumnFloorEtchings(parts, etches, cfg, wing) {
...
export function generateRoof(cfg, plan) {
