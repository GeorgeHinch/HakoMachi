...
import { buildWindowSvgBody, getGroundFloorWindowDims, getWindowDims } from '../data/opening-styles.js?v=hm-assets-20260804-1';
import { embeddedRailOrientation, embeddedRailProfile, embeddedRailsForCfg, sampleLayoutCutSegments } from '../core/layout-cut-geometry.js?v=hm-assets-20260804-1';
import { collectPreviewLayoutCuts, previewLayoutCutsActive } from './layout-cut-helpers.js?v=hm-assets-20260804-1';
import { createPreviewMaterialHelpers } from './material-helpers.js?v=hm-assets-20260804-1';
import { get3DWallProfileForFace, getPreviewEffectiveRidgeDir, isPreviewGabledRoofStyle } from './wall-profile-helpers.js?v=hm-assets-20260804-1';
