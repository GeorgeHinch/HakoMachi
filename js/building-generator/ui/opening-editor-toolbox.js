import { oeWallPlacementXBounds } from './opening-editor-facades.js?v=hm-assets-20260808-01';
...
export function oeToolboxPopulateImpl() {
...
export function oeAddToolboxDragHandlers(card, type, styleKey) {
  if (!card) return;
...
export function oeToolboxDragStartImpl(e, type, styleKey) {
 ...
 */
export function oeGetDoorBands(wall) {
...
export function oeDoorSnappedY(wall, doorH, probeY) {
 ...
 */
export function oeShowOversizeModal(opts) {
...
export function oePlacementDropOpeningImpl(type, dims, x, y, styleKey) {
