...
export const BLOCK_FACES = ['front', 'back', 'east', 'west'];
export const BLOCK_CORE_WALL_ORDER = ['east', 'west', 'front', 'back'];

export function makeBlockContext(rootCfg, opts = {}) {
...
export function blockPartIdSuffix(ctx) {
  return (ctx && ctx.suffix) || '';
}

export function blockPartNamePrefix(ctx) {
  return (ctx && ctx.kind === 'wing') ? `${ctx.label} ` : '';
}

export function applyBlockIdentity(part, ctx, opts = {}) {
...
export function blockFaceFrame(ctx, face) {
...
export function shouldMirrorWingSidePanel(ctx, face) {
...
export function shouldMirrorWingSideExteriorCladding(ctx, face) {
...
export function applyWingSideExteriorCladdingMirror(part, ctx, face) {
...
export function applyWingSidePanelMirror(part, ctx, face, opts = {}) {
...
export function generateBlockCoreWallParts(ctx, opts = {}) {
...
export function generateBlockCladdingParts(ctx, opts = {}) {
  const excludeFaces = opts.excludeFaces || new Set();
...
export function wingConnectionWallKey(wing) {
  return 'front';
}
...
export function wingCoplanarCheck(wing, mainW, mainD) {
...
*/
export function computeFaceMerges(cfg, mainW, mainD) {
  const out = {
...
export function mainWallOpeningsFromWings(cfg) {
...
export function getCoplanarExtensions(cfg) {
