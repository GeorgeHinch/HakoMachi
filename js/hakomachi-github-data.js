...
(function installHakoMachiGithubDataShared() {
  ...
  function slugify(input, fallback = 'hakomachi-building') {
  ...
  function assertSettings(settings, message = 'Add GitHub data settings first.') {
  ...
  function upsertRecord(library, recordType, record) {
  ...
  window.HakoMachiGithubDataShared = {
    SETTINGS_KEY,
