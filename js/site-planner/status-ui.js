export function createStatusUiController({
  ...
  function updateStatus(){
    ...
    if(state.workspaceMode==='track' && (state.trackTask==='trackSwitchLeft' || state.trackTask==='trackSwitchRight')) hints.push('Track switch: click near track to place a left- or right-hand turnout marker. Select it and drag the rotation handle to orient it.');
